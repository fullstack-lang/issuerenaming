...
func SetupModels(logMode bool, filepath string) *gorm.DB {
	...
	gormConfig := &gorm.Config{
		NamingStrategy: schema.NamingStrategy{
			TablePrefix: "github_com_fullstack_lang_issuerenaming_go_", // table name prefix
		},
	}
...
func AutoMigrate(db *gorm.DB) {
	...
	if err != nil {
		msg := err.Error()
		panic("problem with migration " + msg + " on package github.com/fullstack-lang/issuerenaming/go")
	}
	// log.Printf("Database Migration of package github.com/fullstack-lang/issuerenaming/go is OK")
