...
import (
	...
	"github.com/fullstack-lang/issuerenaming/go/fullstack"
	"github.com/fullstack-lang/issuerenaming/go/models"

	gongdoc_load "github.com/fullstack-lang/gongdoc/go/load"

	issuerenaming "github.com/fullstack-lang/issuerenaming"
)
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	models.Stage.Marshall(file, "github.com/fullstack-lang/issuerenaming/go/models", "main")
}

func main() {

	log.SetPrefix("issuerenaming: ")
	log.SetFlags(0)
	...
	r.Use(static.Serve("/", EmbedFolder(issuerenaming.NgDistNg, "ng/dist/ng")))
